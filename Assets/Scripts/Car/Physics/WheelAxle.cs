...
public class WheelAxle
{
    ...
    public void ConfigureVehicleSubsteps(float speedTreshold, int speedBelowTreshold, int stepsAboveThreshold)
    {
        leftWheelCollider.ConfigureVehicleSubsteps(speedTreshold, speedBelowTreshold, stepsAboveThreshold);
        rightWheelCollider.ConfigureVehicleSubsteps(speedTreshold, speedBelowTreshold, stepsAboveThreshold);
    }
